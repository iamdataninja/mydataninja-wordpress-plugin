...
function mdnj_add_ninja_script()
{
  ...
  if ($include_tracker === 'yes') {
    wp_enqueue_script('mydataninja-tracker-script', plugins_url('assets/js/tracker.js', plugin_dir_path(__DIR__)), [], mydataninja_config('VERSION'), true);

    wp_enqueue_script('mydataninja-external-script', 'https://static.mydataninja.com/ninja.js', ['mydataninja-tracker-script'], mydataninja_config('VERSION'), true);
